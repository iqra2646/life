...
const AboutUs = () => {
  return (
    <section className="p-10 bg-gradient-to-b from-blue-50 to-blue-100 text-gray-800">
      <h2 className="text-4xl font-bold mb-8 text-center text-blue-700">About Us</h2>
